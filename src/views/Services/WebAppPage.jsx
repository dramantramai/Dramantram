          ...
          <div className="service-above-fold">
            ...
            <div className="d-block d-lg-none w-100">
              <ServiceHeroMobile
                ...
                videoUrl="https://www.youtube.com/embed/fYxOAHBih_o?si=MypWGf2-bU7wVWL-?rel=0&autoplay=1&mute=1&loop=1"
                serviceColumns={UIUX_SERVICES}
              />
              <ServicesLogosRow serviceColumns={UIUX_SERVICES} showLists={false} />
            </div>
          </div>
