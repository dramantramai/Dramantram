        ...
        <div className="container-fluid">
          ...
          >
              ...
              <div className={`mobile-menu-slider ${activeSubMenu ? "slide-sub" : ""}`}>
                ...
                <div className="mobile-menu-pane main-pane">
                  <ul className="navbar-nav m-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item d-lg-none">
                      <button
                        className="nav-link-light nav-link mobile-menu-item-btn"
                    ...
                    <li className="nav-item">
                      <Link className="nav-link-light nav-link" href="/about" onClick={() => { setIsOpen(false); setActiveSubMenu(null); }}>
                        About Us
                      </Link>
                    </li>
                  </ul>
                  <div className="mobile-contact-wrapper d-lg-none">
                    {isContactPage ? (
                      ...
                      <NavContactButton variant="light" href="/contact" onClick={() => { setIsOpen(false); setActiveSubMenu(null); }}>
                        Contact Us
                      </NavContactButton>
                    )}
                  </div>
                ...
                <div className="mobile-menu-pane sub-pane">
                  ...
                  <ul className="navbar-nav mobile-sub-nav">
                    <li className="nav-item">
                      <Link className="nav-link-light nav-link" href="/services/branding" onClick={() => { setIsOpen(false); setActiveSubMenu(null); }}>
                        Branding
                      </Link>
                    </li>
                    <li className="nav-item">
                      <Link className="nav-link-light nav-link" href="/services/animated-videos" onClick={() => { setIsOpen(false); setActiveSubMenu(null); }}>
                        Animated Videos
                      </Link>
                    </li>
                    <li className="nav-item">
                      <Link className="nav-link-light nav-link" href="/services/live-action" onClick={() => { setIsOpen(false); setActiveSubMenu(null); }}>
                        Live Action
                      </Link>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                      <Link className="nav-link-light nav-link" href="/services/experiential-lab" onClick={() => { setIsOpen(false); setActiveSubMenu(null); }}>
                        Experiential Lab
                      </Link>
                    </li>
                  </ul>
            ...
            {isContactPage ? (
              ...
              <NavContactButton variant="light" href="/contact" className="d-none d-lg-block">
                Contact Us
              </NavContactButton>
            )}
          </div>
